...
template <typename Dtype>
void ConvolutionPoolingLayer<Dtype>::ConvBackward_cpu(const vector<Blob<Dtype>*>& top,
      const vector<bool>& propagate_down, vector<Blob<Dtype>*>* bottom) {
...
#ifdef CPU_ONLY
STUB_GPU(ConvolutionPoolingLayer);
#endif

INSTANTIATE_CLASS(ConvolutionPoolingLayer);
